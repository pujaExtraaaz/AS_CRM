...
<?php echo e(__('Contact Edit')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('title'); ?>
<?php echo e(__('Edit Contact')); ?> <?php echo e('(' . $contact->name . ')'); ?>
...
<div class="btn-group" role="group">
    ...
    <div class="action-btn  ms-2">
        <a href="<?php echo e(route('contact.edit', $previous)); ?>" class="btn btn-sm btn-primary btn-icon m-1"
    ...
    <?php if(!empty($next)): ?>
    <div class="action-btn ms-2">
        <a href="<?php echo e(route('contact.edit', $next)); ?>" class="btn btn-sm btn-primary btn-icon m-1"
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div id="useradd-1" class="card">
                    <?php echo e(Form::model($contact, ['route' => ['contact.update', $contact->id], 'method' => 'PUT'])); ?>
                    ...
                    <div class="card-header">
                        ...
                        <div class="text-end">
                            <a href="#" data-size="md" class="btn btn-sm btn-primary "
                               ...
                               data-url="<?php echo e(route('generate', ['contact'])); ?>" data-toggle="tooltip"
                        ...
                        <small class="text-muted"><?php echo e(__('Edit about your contact information')); ?></small>
                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('contact_address', __('Address'), ['class' => 'form-label'])); ?>

                                        <?php echo e(Form::text('contact_address', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Address')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('contact_country', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('contact_state', __('State'), ['class' => 'form-label'])); ?>

                                        <?php echo e(Form::text('contact_state', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('contact_city', __('City'), ['class' => 'form-label'])); ?>

                                        <?php echo e(Form::text('contact_city', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('contact_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::select('user', $user, $contact->user_id, ['class' => 'form-control ']); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div id="useradd-2" class="card">
                    <?php echo e(Form::open(['route' => ['streamstore', ['contact', $contact->name, $contact->id]], 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>

                    <div class="card-header">
                        <h5><?php echo e(__('Stream')); ?></h5>
                        <small class="text-muted"><?php echo e(__('Add stream information')); ?></small>
                    </div>
                    <div class="card-body">
                        <form>
                            <div class="row">
                                        ...
                                        <li class="list-group-item border-0 d-flex align-items-start mb-2">
                                            ...
                                            <div class="d-block d-sm-flex align-items-center right-side">
                                                ...
                                                <div class=" ms-2  d-flex align-items-center ">
                                                    <small
                                                        class="text-end "><?php echo e($stream->created_at); ?></small>
                                                </div>
                                            </div>
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned opportunities for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('opportunities.create', ['contact', $contact->id])); ?>"
                            ...
                            <table class="table datatable" id="datatable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="budget">
                                            <?php echo e(!empty($opportunities->account_names) ? $opportunities->account_names->name : '-'); ?>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="action-btn bg-info ms-2">
                                                <a href="<?php echo e(route('opportunities.edit', $opportunities->id)); ?>"
                                                   ...
                                                   data-title="<?php echo e(__('Edit Opportunities')); ?>"><i
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned tasks for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg" data-url="<?php echo e(route('task.create',['task',0])); ?>"
                                       data-ajax-popup="true" title="<?php echo e(__('Create')); ?>" data-bs-toggle="tooltip"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned Quotes for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('quote.create', ['shipping_contact', $contact->id])); ?>"
                                       data-ajax-popup="true" title="<?php echo e(__('Create')); ?>" data-bs-toggle="tooltip"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned SalesOrder for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('salesorder.create', ['shipping_contact', $contact->id])); ?>"
                                       data-ajax-popup="true" data-bs-toggle="tooltip"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned SalesInvoice for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('invoice.create', ['shipping_contact', $contact->id])); ?>"
                                       data-ajax-popup="true" data-bs-toggle="tooltip"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned Cases for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('commoncases.create', ['contact', $contact->id])); ?>"
                                       data-ajax-popup="true" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
                    ...
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                ...
                                <small class="text-muted"><?php echo e(__('Assigned Call for this contact')); ?></small>
                            </div>
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('call.create', ['attendees_contact', 0])); ?>"
                                       data-ajax-popup="true" data-bs-toggle="tooltip"
                                       data-title="<?php echo e(__('Create New Call')); ?>" title="<?php echo e(__('Create')); ?>"
                                       class="btn btn-sm btn-primary btn-icon-only ">
                                        <i class="ti ti-plus"></i>
                                    </a>
                                </div>
                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="text-end">
                                    <a href="#" data-size="lg"
                                       data-url="<?php echo e(route('meeting.create', ['attendees_contact', 0])); ?>"
                                       data-ajax-popup="true" data-bs-toggle="tooltip"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CRM\resources\views/contact/edit.blade.php ENDPATH**/ ?>