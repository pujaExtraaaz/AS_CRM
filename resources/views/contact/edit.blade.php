                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('contact_address', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Address')]) }}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('contact_country', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')]) }}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('contact_state', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')]) }}
                                        @error('contact_state')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('contact_city', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')]) }}
                                        @error('contact_city')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('contact_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing City')]) }}
