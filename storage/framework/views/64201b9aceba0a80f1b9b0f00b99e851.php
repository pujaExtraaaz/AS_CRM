...
<header class="dash-header transprent-bg">
    ...
    <audio id="alarmSound" src="<?php echo e(asset('public\sounds\alarm.mp3')); ?>" preload="auto" loop></audio>
                        ...
                        <div class="dropdown-menu dash-h-dropdown dropdown-menu-end">
                            ...
                            <a href="#" data-url="<?php echo e(route('create.language')); ?>"
                               ...
                               data-ajax-popup="true" data-title="<?php echo e(__('Create New Language')); ?>">
                                <span><?php echo e(__('Create Languages')); ?></span>
                            </a>
...
<?php /**PATH E:\xampp2\htdocs\AS_CRM\resources\views/partials/admin/header.blade.php ENDPATH**/ ?>