...
<?php echo e(__('Sales Return')); ?> <?php echo e('(' . \Auth::user()->salesorderNumberFormat($salesreturn->salesorder_id) . ')'); ?>
...
<div class="action-btn ms-2">
    <a href="<?php echo e(route('sales_return.edit', $salesreturn->id)); ?>" class="btn btn-sm btn-info btn-icon m-1"
...
<?php endif; ?>
<div class="action-btn ms-2">
    <a href="#" data-size="md" data-url="<?php echo e(route('sales_return.create', $salesreturn->id)); ?>"
       data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('Create New SalesReturn')); ?>"
                                    ...
                                    <table class="table invoice-detail-table">
                                        <thead>
                                            <tr class="thead-default">
                                                <th scope="col" class="sort" data-sort="id"><?php echo e(__('Sales Return ID')); ?></th><td><?php echo e(\Auth::user()->salesReturnFormat($salesreturn->id)); ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="col" class="sort" data-sort="name"><?php echo e(__('Sales Order No')); ?></th><td><?php echo e(\Auth::user()->salesorderNumberFormat($salesreturn->salesorder_id)); ?> </td>
                                            </tr>
                                            <tr>
                                                <th scope="col" class="sort" data-sort="completion"><?php echo e(__('Return Date')); ?> </th><td><?php echo e(\Auth::user()->dateFormat($salesreturn->return_date)); ?> </td>          
                                            </tr>
                                            <tr>
                                                <th scope="col" class="sort" data-sort="completion"><?php echo e(__('Request Type')); ?></th><td><?php echo e(__(\App\Models\SalesReturn::$request_type[$salesreturn->request_type])); ?></td>
                                            </tr>
                                            <tr>
                                                <th scope="col" class="sort" data-sort="completion"><?php echo e(__('Return By User')); ?></th><td><?php echo e(ucfirst(!empty($salesreturn->source_user) ? $salesreturn->source_user->name : '-')); ?></td>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\AS_CRM\resources\views/sales_return/view.blade.php ENDPATH**/ ?>