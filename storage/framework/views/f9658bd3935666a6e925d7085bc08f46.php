...
<div class="card mb-4">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group" role="group">
            ...
            <a href="<?php echo e(route('part_type.index')); ?>" class="btn btn-primary ms-2">
                Top Performer
            </a>

            <a href="<?php echo e(route('part_type.index')); ?>" class="btn btn-success ms-2">
                Your Standing Gp
            </a>

            <a href="<?php echo e(route('part_type.index')); ?>" class="btn btn-info ms-2">
                Total Sales
            </a>

            <a href="<?php echo e(route('part_type.index')); ?>" class="btn btn-warning ms-2">
                Target Pending
            </a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp2\htdocs\AS_CRM\resources\views/home.blade.php ENDPATH**/ ?>