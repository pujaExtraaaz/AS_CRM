...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('Edit Case')); ?> <?php echo e('(' . $commonCase->name . ')'); ?>
    ...
    <div class="btn-group" role="group">
        <?php if(!empty($previous)): ?>
            <div class="action-btn  ms-2">
                <a href="<?php echo e(route('commoncases.edit', $previous)); ?>" class="btn btn-sm btn-primary btn-icon m-1"
        ...
        <?php if(!empty($next)): ?>
            <div class="action-btn  ms-2">
                <a href="<?php echo e(route('commoncases.edit', $next)); ?>" class="btn btn-sm btn-primary btn-icon m-1"
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('commoncases.index')); ?>"><?php echo e(__('Case')); ?></a></li>
            ...
            <div class="row">
                ...
                <div class="col-xl-9">
                    <div id="useradd-1" class="card">
                        <?php echo e(Form::model($commonCase, ['route' => ['commoncases.update', $commonCase->id], 'method' => 'PUT'])); ?>
                        ...
                        <div class="card-header">
                            <?php if(isset($plansettings['enable_chatgpt']) && $plansettings['enable_chatgpt'] == 'on'): ?>
                                <div class="float-end">
                                    <a href="#" data-size="md" class="btn btn-sm btn-primary "
                                        ...
                                        data-url="<?php echo e(route('generate', ['case'])); ?>" data-toggle="tooltip"
                            ...
                            <?php endif; ?>
                            <h5><?php echo e(__('Overview')); ?>

                            </h5>

                            <small class="text-muted"><?php echo e(__('Edit about your case information')); ?></small>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::text('number', null, ['class' => 'form-control', 'placeholder' => __('Enter Name'), 'disabled'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::select('contact', $contacts, null, ['class' => 'form-control ']); ?>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <?php echo Form::select('user', $user, $commonCase->user_id, ['class' => 'form-control ']); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="useradd-2" class="card">
                        <?php echo e(Form::open(['route' => ['streamstore', ['commoncases', $commonCase->name, $commonCase->id]], 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
                        ...
                        <div class="col-12">
                            ...
                            <?php $__currentLoopData = $streams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stream): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                ?>
                                <?php if($remark->data_id == $commonCase->id): ?>
                                    <div class="card-body">
                                        <div class="row">
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <small class="text-muted"><?php echo e(__('Assigned task for this case')); ?></small>
                                </div>
                                <div class="col">
                                    <div class="text-end">
                                        <a href="#" data-size="lg"
                                            data-url="<?php echo e(route('task.create', ['task', 0])); ?>" data-ajax-popup="true"
                                ...
                                <table class="table datatable" id="datatable">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <a href="<?php echo e(route('task.edit', $task->id)); ?>" data-size="lg"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CRM\resources\views/commoncase/edit.blade.php ENDPATH**/ ?>