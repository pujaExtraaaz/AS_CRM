                 ...
                 <div class="col-xxl-12 col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body adj_card">
                            <div id="traffic-chart" style="width: 100%; min-height: 200px;"></div>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="card" style="min-height:205px;">
                                        <div class="card-header">
                                            <h4 ><?php echo e(__('Storage Status')); ?> <small>(<?php echo e(isset( $users->storage_limit) ? $users->storage_limit . 'MB' : ''); ?> / <?php echo e(isset($plan->storage_limit) ?$plan->storage_limit . 'MB' : ''); ?>)</small></h4>
                                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CRM\resources\views/home.blade.php ENDPATH**/ ?>