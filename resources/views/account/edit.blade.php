                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('billing_address', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Address')]) }}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{ Form::text('shipping_address', null, ['class' => 'form-control', 'placeholder' => __('Enter Shipping Address')]) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('billing_country', __('Billing Country'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('state', __('Billing State'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('shipping_country', __('Shipping Country'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('state', __('Shipping State'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('city', __('Billing City'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('billing_postalcode', __('Billing Postal Code'), ['class' => 'form-label']) }}
                                        {{ Form::number('billing_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Postal Code')]) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('city', __('Shipping City'), ['class' => 'form-label']) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::label('shipping_postalcode', __('Shipping Postal Code'), ['class' => 'form-label']) }}
                                        {{ Form::number('shipping_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Shipping Postal Code')]) }}
