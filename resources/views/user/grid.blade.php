...
@else
    @section('title')
        <div class="page-header-title">
            <h4 class="m-b-10">{{ __('Users Settings') }}</h4>
        </div>
    @endsection
@endif
...
@section('action-btn')
    ...
    @can('Create User')
        ...
        <a href="#" data-url="{{ route('user.create') }}" data-size="md" data-ajax-popup="true" data-bs-toggle="tooltip"
            title="{{ __('Create') }}" data-title="{{ __('Create New Company') }}" class="btn btn-sm btn-primary btn-icon">
            ...
            <div class="row">
                                            ...
                                            @if (Gate::check('Create User') || Gate::check('Edit User') || Gate::check('Delete User'))
                                                @can('Edit User')
                                                    <a href="{{ route('user.edit', $user->id) }}" class="dropdown-item"
                                                        data-bs-whatever="{{ __('Edit Users Setting') }}" data-bs-toggle="tooltip"
                                                        data-title="{{ __('Edit Users Setting') }}"><i class="ti ti-edit"></i>
                                                        {{ __('Edit') }}</a>
                                                @endcan
                                                @can('Create User')
                ...
                <div class="col-md-3">
                    <a href="#" class="btn-addnew-project" data-ajax-popup="true" data-size="md"
                        data-title="{{ __('Create New Users Setting') }}" data-url="{{ route('user.create') }}">
                    ...
                    <div class="row">
                                    ...
                                    <div class="card-header border-0 pb-0">
                                        ...
                                        <div class="card-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-4">
                                                                    <p class="text-muted text-sm mb-0"
                                                                        data-bs-toggle="tooltip" title="{{ __('Users Settings') }}">
                                                                        <i
                                            ...
                                            {{-- <div class="col-4 text-center">
                                                        ...
                                                        <span class="d-block text-sm text-muted">{{ __('Users Setting') }}</span>
                                                    </div>
                                                    <div class="col-4 text-center">
                        ...
                        <div class="col-md-3">
                            <a href="#" class="btn-addnew-project" data-ajax-popup="true" data-size="md"
                                ...
                                <h6 class="mt-4 mb-2">New Users Setting</h6>
                                <p class="text-muted text-center">Click here to add New Users Setting</p>
                            </a>
                        </div>
                    </div>
                </div>
