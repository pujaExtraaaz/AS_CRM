...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::group(
            ...
            function () {
                ...
                Route::get('/leads/notify', [LeadController::class, 'getLeadforNotify']);
                Route::get('/leads/assign/{id}', [LeadController::class, 'assign_leads']);
                Route::get('/leads/{lead}/status-logs', [LeadController::class, 'statusLogs'])->name('lead.status.logs');
            }
    );
    Route::group(
            [
    ...
    Route::group(
            ...
            function () {
                ...
                Route::post('salesorder/{id}/save-yard-logs', [SalesOrderController::class, 'createYardLogs'])->name('salesorder.save-yard-logs');
                Route::post('salesorder/{id}/select-yards', [SalesOrderController::class, 'selectYards'])->name('salesorder.select-yards');
                Route::post('salesorder/yard-log/{logId}/update-status', [SalesOrderController::class, 'updateYardLogStatus'])->name('salesorder.yard-log.update-status');
                Route::post('salesorder/yard-log/{logId}/update-delivery-status', [SalesOrderController::class, 'updateYardLogDeliveryStatus'])->name('salesorder.yard-log.update-delivery-status');
                Route::post('salesorder/yard-log/{logId}/update-request', [SalesOrderController::class, 'updateYardRequest'])->name('salesorder.yard-log.update-request');
                Route::post('salesorder/yard-log/{logId}/update-product-delivery', [SalesOrderController::class, 'updateProductDelivery'])->name('salesorder.yard-log.update-product-delivery');
                ...
                Route::get('salesinvoice/export', [SalesInvoiceController::class, 'export'])->name('salesinvoice.export');
            }
    );
