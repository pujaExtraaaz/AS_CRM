...
Once a lead is submitted through the API, it will appear in your CRM system under the Leads section. 

**Important Note on Lead Visibility:**
- New leads submitted through the API will initially be visible only to admin users
- Regular users will not see these leads until they are explicitly assigned
- The admin can assign leads to specific users from the admin dashboard

To access leads as an admin:
...
4. To assign a lead to a user, edit the lead and select a user from the dropdown

### 6. Lead Assignment Process

To assign leads to users:
...
Once assigned, the lead will become visible to the assigned user in their dashboard.
