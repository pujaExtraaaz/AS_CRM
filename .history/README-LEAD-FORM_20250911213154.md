...
### 5. Lead Visibility and Assignment

When a lead is submitted through the API:

- New leads are automatically assigned to the admin user (user_id = 1)
- Leads are created with created_by = 3
- Leads have source set to 'website'
- By default, these leads will only be visible to admin users in the CRM
- Regular users cannot see the leads until they are explicitly reassigned
- Admin can reassign leads to specific users through the CRM interface

To access and manage leads as an admin:

1. Log in to your CRM dashboard as an admin
2. Navigate to "Leads" in the sidebar
3. The new leads will appear in the list with a status of "New"
4. To reassign a lead to another user, edit the lead and select a user from the dropdown

### 6. Lead Assignment Process

To reassign leads to other users:

1. Log in as an admin
2. Go to the Leads section
3. Click on a lead to view its details
4. Click the "Edit" button
5. In the "Assigned To" dropdown, select the user
6. Save the changes

Once reassigned, the lead will become visible to the assigned user in their dashboard.
