...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo Form::select('stage', $opportunities_stage, null,array('class' => 'form-control ')); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::number('probability',null,array('class'=>'form-control','placeholder'=>__('Enter Probability')))); ?>
...
<?php /**PATH D:\xampp\htdocs\CRM\resources\views/opportunities/create.blade.php ENDPATH**/ ?>