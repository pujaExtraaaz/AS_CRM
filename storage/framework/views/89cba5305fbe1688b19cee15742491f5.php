...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('phone', null, ['class' => 'form-control', 'placeholder' => __('Enter Phone'),'maxlength'=>10 ,'required' => 'required'])); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('billing_address', null, ['class' => 'form-control', 'placeholder' => __('Billing Address')])); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('shipping_address', null, ['class' => 'form-control', 'placeholder' => __('Shipping Address')])); ?>

        </div>
    </div>
     <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_country', null, ['class' => 'form-control', 'placeholder' => __('Billing Country')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_state', null, ['class' => 'form-control', 'placeholder' => __('Billing State')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_country', null, ['class' => 'form-control', 'placeholder' => __('Shipping Country')])); ?>

        </div>
    </div>    
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_state', null, ['class' => 'form-control', 'placeholder' => __('Shipping State')])); ?>

        </div>
    </div>   
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_city', null, ['class' => 'form-control', 'placeholder' => __('Billing City')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Billing Postal Code')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_city', null, ['class' => 'form-control', 'placeholder' => __('Shipping City')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Shipping Postal Code')])); ?>
...
<?php /**PATH D:\xampp\htdocs\CRM\resources\views/account/create.blade.php ENDPATH**/ ?>