...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('contact_postalcode',null,array('class'=>'form-control','placeholder'=>__('Postal Code'),'required'=>'required'))); ?>
...
<?php /**PATH /home/u766425373/domains/extraaaz.com/public_html/live/resources/views/contact/create.blade.php ENDPATH**/ ?>