...
<div>
    <div class="message-card">
        <div class="image-file chat-image"
            style="width: 250px; height: 150px;background-image: url('<?php echo e(asset('storage/'.config('chatify.attachments.folder').'/'.$attachment[0])); ?>')">
        </div>
    </div>
</div>
<?php endif; ?>
...
<div class="message-card mc-sender " data-id="<?php echo e($id); ?>">
    <p class="bg-primary"><?php echo ($message == null && $attachment != null && @$attachment[2] != 'file') ? $attachment[1] : nl2br($message); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/u766425373/domains/extraaaz.com/public_html/live/resources/views/vendor/Chatify/layouts/messageCard.blade.php ENDPATH**/ ?>