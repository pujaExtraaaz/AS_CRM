...
@endphp
{{Form::open(array('url'=>'dispute','method'=>'post','enctype'=>'multipart/form-data',"autocomplete"=>"off"))}}
<div class="row">
    <div class="col-12">
        <div class="form-group">
            ...
            <input type="hidden" name="dispute_id" id="dispute_id" value="{{$dispute_no}}">
        </div>
    </div>   
    <div class="col-12">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {{Form::date('dispute_date',date('Y-m-d'),array('class'=>'form-control datepicker','required'=>'required'))}}
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {{Form::select('dispute_type',$dispute_type,null,array('class'=>'form-control','required'=>'required'))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('dispute_status',__('Status'),['class'=>'form-label']) }}
            {{Form::select('dispute_status',$dispute_status,'Pending',array('class'=>'form-control'))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            ...
            <div class="input-group"><span class="input-group-text">$</span>
                {{Form::number('disputed_amount',null,array('class'=>'form-control','placeholder'=>__('Enter Disputed Amount'),'step'=>'0.01','min'=>'0','required'=>'required'))}}
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            ...
            <div class="input-group"><span class="input-group-text">$</span>
                {{Form::number('gp_deduction',null,array('class'=>'form-control','placeholder'=>__('Enter GP Deduction'),'step'=>'0.01','min'=>'0'))}}
            </div>
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            ...
            <div class="input-group"><span class="input-group-text">$</span>
                {{Form::number('loss',null,array('class'=>'form-control','placeholder'=>__('Enter Loss'),'step'=>'0.01','min'=>'0'))}}
            </div>
        </div>
    </div>
    <div class="col-12">
