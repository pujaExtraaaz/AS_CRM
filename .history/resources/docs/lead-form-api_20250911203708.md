...
1. The lead is initially visible only to admin users in the CRM
2. An email notification is sent to the admin email address
3. Regular users cannot see the lead until it is explicitly assigned to them
4. Admins can assign leads to specific users through the CRM interface
