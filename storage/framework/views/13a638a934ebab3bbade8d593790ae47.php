<?php if(\Auth::user()->type == 'super admin'): ?>
    <?php echo e(Form::open(['url' => 'user', 'method' => 'post', 'enctype' => 'multipart/form-data'])); ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <div class="form-group ">
                ...
                <?php echo Form::select('gender', $gender, null, ['class' => 'form-control', 'required' => 'required']); ?>
...
<?php /**PATH /home/u766425373/domains/extraaaz.com/public_html/live/resources/views/user/create.blade.php ENDPATH**/ ?>