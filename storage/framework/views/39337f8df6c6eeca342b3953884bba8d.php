...
<div class="row">
    ...
    <div class="col-9">
        <div class="form-group">
            <?php echo e(Form::label('lead', __('Select Lead'), ['class' => 'form-label'])); ?>

            <?php echo Form::select('lead', $lead, null, ['id' => 'lead', 'class' => 'form-control', 'required' => 'required']); ?>
    ...
    <div class="col-3">
        ...
        <div class="form-group">
            <?php echo e(Form::label('lead', __('Select Lead'), ['class' => 'form-label invisible'])); ?>

            <a href="javascript::void(0);" data-url="<?php echo e(route('lead.create',['lead',0])); ?>" data-size="lg" data-ajax-popup="true" data-bs-toggle="tooltip" data-title="<?php echo e(__('Create New Lead')); ?>"title="<?php echo e(__('Create')); ?>" class="btn btn-primary btn-icon m-1">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('quote_number', \Auth::user()->quoteNumberFormat($quote_no) , ['class' => 'form-control','disabled'])); ?>

            <input type="hidden" name="quote_id" id="quote_id" value="<?php echo e($quote_no); ?>">
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('billing_address', null, ['id' => 'billing_address', 'class' => 'form-control', 'placeholder' => __('Billing Address')])); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('shipping_address', null, ['id' => 'shipping_address', 'class' => 'form-control', 'placeholder' => __('Shipping Address')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_country', null, ['id' => 'billing_country', 'class' => 'form-control', 'placeholder' => __('Billing Country')])); ?>

        </div>
    </div>    
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_state', null, ['id' => 'billing_state', 'class' => 'form-control', 'placeholder' => __('Billing State')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_country', null, ['id' => 'shipping_country', 'class' => 'form-control', 'placeholder' => __('Shipping Country')])); ?>

        </div>
    </div>    
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_state', null, ['id' => 'shipping_state', 'class' => 'form-control', 'placeholder' => __('Shipping State')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_city', null, ['id' => 'billing_city', 'class' => 'form-control', 'placeholder' => __('Billing city')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('billing_postalcode', null, ['id' => 'billing_postalcode', 'class' => 'form-control', 'placeholder' => __('Billing Postal Code')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_city', null, ['id' => 'shipping_city', 'class' => 'form-control', 'placeholder' => __('Shipping City')])); ?>

        </div>
    </div>
    <div class="col-3">
        <div class="form-group">
            <?php echo e(Form::text('shipping_postalcode', null, ['id' => 'shipping_postalcode', 'class' => 'form-control', 'placeholder' => __('Shipping Postal Code')])); ?>
...
<div class="col-6">
    <div class="form-group">
        ...
        <?php echo Form::select('shipping_provider', $shipping_provider, null, ['class' => 'form-control']); ?>
...
<?php /**PATH D:\xampp\htdocs\CRM\resources\views/quote/create.blade.php ENDPATH**/ ?>