                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('salesorder', $salesorder, null,array('class' => 'form-control','required'=>'required')) !!}
                                        @error('salesorder')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{Form::text('invoice_number',\Auth::user()->invoiceNumberFormat($invoice->invoice_id),array('class'=>'form-control','placeholder'=>__('invoice Number'),'disabled'))}}
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{Form::date('date_quoted',date('Y-m-d'),array('class'=>'form-control datepicker','placeholder'=>__('Date Quoted'),'required'=>'required'))}}
                                        @error('date_quoted')
...
<!--                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {{Form::number('quote_number',null,array('class'=>'form-control','placeholder'=>__('Quote Number'),'required'=>'required'))}}
                                        @error('quote_number')
                                ...
                                @error('tax')
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            {{Form::textarea('description',null,array('class'=>'form-control','rows'=>2,'placeholder'=>__('Name')))}}
                                        </div>
                                    </div>
                                    <div class="text-end">
