...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo Form::select('quote', $quote, null,array('class' => 'form-control','data-toggle'=>'select','required'=>'required')); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::text('sales_order_number',\Auth::user()->salesorderNumberFormat($sales_no) ,array('class'=>'form-control','placeholder'=>__('Sales Order Number'),'required'=>'required','disabled'))); ?>

            <input type="hidden" name="salesorder_id" id="salesorder_id" value="<?php echo e($sales_no); ?>">
        </div>
    </div>      
    <div class="col-6">
        <div class="form-group">
...
<div class="col-6">
    <div class="form-group">
        ...
        <?php echo Form::select('shipping_provider', $shipping_provider, null,array('class' => 'form-control','data-toggle'=>'select')); ?>
...
<?php /**PATH D:\xampp\htdocs\CRM\resources\views/salesorder/create.blade.php ENDPATH**/ ?>