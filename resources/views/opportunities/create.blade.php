...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {!!Form::select('stage', $opportunities_stage, null,array('class' => 'form-control ')) !!}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('probability',__('Probability'),['class'=>'form-label']) }}
            {{Form::number('probability',null,array('class'=>'form-control','placeholder'=>__('Enter Probability')))}}
        </div>
    </div>
