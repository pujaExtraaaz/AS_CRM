...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('quote.index')); ?>"><?php echo e(__('Quote')); ?></a></li>
...
<?php $__env->startSection('action-btn'); ?>
    <div class="action-btn bg-warning ms-2">
        <a href="<?php echo e(route('quote.pdf', \Crypt::encrypt($quote->id))); ?>" target="_blank" class="btn btn-sm btn-primary btn-icon"
            data-bs-toggle="tooltip" title="<?php echo e(__('Print')); ?>">
    ...
    <?php if(Auth::user()->type == 'owner'): ?>
        <div class="action-btn ms-2">
            <a href="#" class="btn btn-sm btn-warning btn-icon m-1 cp_link"
                data-link="<?php echo e(route('pay.quote', \Illuminate\Support\Facades\Crypt::encrypt($quote->id))); ?>"
                data-bs-toggle="tooltip"
                data-title="<?php echo e(__('Click to copy Quote link')); ?>"title="<?php echo e(__('copy quote')); ?>"><span
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Quote')): ?>
        <div class="action-btn ms-2">
            <a href="<?php echo e(route('quote.edit', $quote->id)); ?>" class="btn btn-sm btn-info btn-icon m-1" data-bs-toggle="tooltip" data-title="<?php echo e(__('Edit Quote Item')); ?>"
                title="<?php echo e(__('Edit')); ?>" data-title="<?php echo e(__('Edit Quote')); ?>"><i class="ti ti-edit"></i></a>
        </div>
    <?php endif; ?>
    <div class="action-btn ms-2">
        <a href="#" data-url="<?php echo e(route('quote.quoteitem', $quote->id)); ?>" data-size="md" data-ajax-popup="true"
            data-bs-toggle="tooltip" data-title="<?php echo e(__('Create New Quote Item')); ?>"title="<?php echo e(__('Create')); ?>"
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <div class="col-lg-6 col-md-8 pl-0">
                                        ...
                                        <span class="col-sm-8"><span
                                                class="text-sm"><?php echo e(\Auth::user()->quoteNumberFormat($quote->id)); ?></span></span>
                                    </div>
                                    <div class="col-lg-6 col-md-8 pl-0 mt-3">
                                        <h6 class="d-inline-block m-0 d-print-none"><?php echo e(__('Quote Date')); ?></h6>
                                        <span class="col-sm-8"><span
                                                class="text-sm"><?php echo e(\Auth::user()->dateFormat($quote->created_at)); ?></span></span>
                                    </div>
                                    <h6 class="d-inline-block m-0 d-print-none mt-3"><?php echo e(__('Quote ')); ?></h6>

                                    <?php if($quote->status == 0): ?>
                                        <span
                                            class="badge bg-primary p-2 px-3 rounded"><?php echo e(__(\App\Models\Quote::$status[$quote->status])); ?></span>
                                    <?php elseif($quote->status == 1): ?>
                                        <span
                                            class="badge bg-danger p-2 px-3 rounded"><?php echo e(__(\App\Models\Quote::$status[$quote->status])); ?></span>
                                    <?php elseif($quote->status == 2): ?>
                                        <span
                                            class="badge bg-warning p-2 px-3 rounded"><?php echo e(__(\App\Models\Quote::$status[$quote->status])); ?></span>
                                    <?php elseif($quote->status == 3): ?>
                                        <span
                                            class="badge bg-success p-2 px-3 rounded"><?php echo e(__(\App\Models\Quote::$status[$quote->status])); ?></span>
                                    <?php elseif($quote->status == 4): ?>
                                        <span
                                            class="badge bg-info p-2 px-3 rounded"><?php echo e(__(\App\Models\Quote::$status[$quote->status])); ?></span>
                                    <?php endif; ?>
                                </div>
                                        ...
                                        <table class="table invoice-detail-table">
                                            ...
                                            <tbody>
                                                ...
                                                <?php $__currentLoopData = $quote->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $quoteitem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    ?>
                                                    <tr>
                                                        <td><?php echo e(!empty($quoteitem->items->name) ? $quoteitem->items->name : ''); ?>

                                                        </td>
                                                        <td><?php echo e($quoteitem->quantity); ?> </td>
                                                        <td><?php echo e(\Auth::user()->priceFormat($quoteitem->price)); ?> </td>
                                                        <td>
                                                            <div class="col">
                                                                <?php
                                                                    $totalTaxPrice = 0;
                                                                ...
                                                                <?php if(!empty($quoteitem->tax)): ?>
                                                                    <?php $__currentLoopData = $quoteitem->tax($quoteitem->tax); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tax): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php
                                                                            ...
                                                                            $data+=$taxPrice;
                                                                        ?>
                                                                        <a href="#!" class="d-block text-sm text-muted"><?php echo e($tax->tax_name .' ('.$tax->rate .'%)'); ?> &nbsp;&nbsp;<?php echo e(\Auth::user()->priceFormat($taxPrice)); ?></a>
                                                        ...
                                                        <td class="px-0">
                                                            <?php echo e(\Auth::user()->priceFormat($quoteitem->discount)); ?> </td>
                                                        <td class="px-0">
                                                            <?php echo e(!empty($quoteitem->description) ? $quoteitem->description : '--'); ?>
                                                        ...
                                                        ?>
                                                            <?php echo e(\Auth::user()->priceFormat($quoteitem->price * $quoteitem->quantity - $quoteitem->discount + $tr_tex)); ?>
                                                        ...
                                                        <td>
                                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Quote')): ?>
                                                                <div class="action-btn bg-info ms-2">
                                                                    <a href="#"
                                                                        data-url="<?php echo e(route('quote.quoteitem.edit', $quoteitem->id)); ?>"
                                        ...
                                        <table class="table invoice-table ">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><?php echo e(\Auth::user()->priceFormat($quote->getSubTotal())); ?></td>
                                                </tr>
                                                <tr>
                                                    <th><?php echo e(__('Discount :')); ?></th>
                                                    <td><?php echo e(\Auth::user()->priceFormat($quote->getTotalDiscount())); ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h5 class="text-primary subTotal">
                                                            <?php echo e(\Auth::user()->priceFormat($quote->getTotal())); ?></h5>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4">
                                    ...
                                    <dl class="row mt-4 align-items-center">
                                        ...
                                        <dd class="col-sm-6"><span class="text-sm"><?php echo e($quote->billing_address); ?></span>
                                        </dd>
                                        ...
                                        <dd class="col-sm-6"><span
                                                class="text-sm"><?php echo e($quote->billing_postalcode); ?></span></dd>

                                        <dt class="col-sm-6"><span
                                                class="h6 text-sm mb-0"><?php echo e(__('Billing Country')); ?></span></dt>
                                        <dd class="col-sm-6"><span class="text-sm"><?php echo e($quote->billing_country); ?></span>
                                        </dd>

                                        <dt class="col-sm-6"><span
                                                class="h6 text-sm mb-0"><?php echo e(__('Billing Contact')); ?></span></dt>
                                        <dd class="col-sm-6"><span
                                                class="text-sm"><?php echo e(!empty($quote->contacts->name) ? $quote->contacts->name : '--'); ?></span>
                                        </dd>
                                    </dl>
                                </div>
                                <?php if(\Utility::getValByName('shipping_display') == 'on'): ?>
                                    <div class="col-12 col-md-4">
                                        ...
                                        <dl class="row mt-4 align-items-center">
                                            ...
                                            <dd class="col-sm-6"><span
                                                    class="text-sm"><?php echo e($quote->shipping_address); ?></span></dd>

                                            <dt class="col-sm-6"><span
                                                    class="h6 text-sm mb-0"><?php echo e(__('Shipping City')); ?></span></dt>
                                            <dd class="col-sm-6"><span class="text-sm"><?php echo e($quote->shipping_city); ?></span>
                                            </dd>

                                            <dt class="col-sm-6"><span
                                                    class="h6 text-sm mb-0"><?php echo e(__('Zip Code')); ?></span></dt>
                                            <dd class="col-sm-6"><span
                                                    class="text-sm"><?php echo e($quote->shipping_postalcode); ?></span></dd>

                                            <dt class="col-sm-6"><span
                                                    class="h6 text-sm mb-0"><?php echo e(__('Shipping Country')); ?></span></dt>
                                            <dd class="col-sm-6"><span
                                                    class="text-sm"><?php echo e($quote->shipping_country); ?></span></dd>
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <dd class="col-sm-12"><span
                                        class="text-sm"><?php echo e(!empty($quote->assign_user) ? $quote->assign_user->name : ''); ?></span>
                                </dd>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CRM\resources\views/quote/view.blade.php ENDPATH**/ ?>