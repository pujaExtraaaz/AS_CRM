...
<script>
        ...
        window.onload = function() {
            $.ajax({
            type: "GET",
            url: '{{ url("/leads/notify")}}',
            success: function (response) {                
                if(response){
                    var edit_url = '{{ url("/lead/'+ response.id+'/edit")}}';
                    ...
                    setTimeout(() => {
                        ...
                        if (userConfirmed) { 
                             $.ajax({
                                type: "GET",
                                url: '{{ url("/leads/assign")}}/' + response.id,
                                success: function (resp) {
                                   console.log("Done");
                                   location.href = '{{ url("/lead")}}/'+response.id+'/edit';
                                },
...
<script>
    ...
    <script>
        var toster_pos = "{{env('SITE_RTL') =='on' ?'left' : 'right'}}";</script>
