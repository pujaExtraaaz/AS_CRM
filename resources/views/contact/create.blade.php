...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            {{Form::text('contact_address',null,array('class'=>'form-control','placeholder'=>__('Address')))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('contact_country',__('Country'),['class'=>'form-label']) }}
            {{Form::text('contact_country',null,array('class'=>'form-control','placeholder'=>__('Country')))}}
        </div>
    </div>    
    <div class="col-6">
        <div class="form-group">
            {{Form::label('contactaddress',__('State'),['class'=>'form-label']) }}
            {{Form::text('contact_state',null,array('class'=>'form-control','placeholder'=>__('State')))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('contactaddress',__('City'),['class'=>'form-label']) }}
            {{Form::text('contact_city',null,array('class'=>'form-control','placeholder'=>__('City')))}}
        </div>
    </div>
    <div class="col-6">
        <div class="form-group">
            {{Form::label('contact_postalcode',__('Postal Code'),['class'=>'form-label']) }}
            {{Form::text('contact_postalcode',null,array('class'=>'form-control','placeholder'=>__('Postal Code')))}}
        </div>
    </div>
