        ...
        <div class="footer-wrapper">
            <div class="py-1">
                <span class="text-muted">&copy;
                    ...
                    <?php echo e(App\Models\Utility::getValByName('footer_text') ? App\Models\Utility::getValByName('footer_text') : config('app.name', 'Salesy Saas')); ?></span>
            </div>
        </div>
    </footer>
...
<?php /**PATH /home/u766425373/domains/extraaaz.com/public_html/live/resources/views/layouts/admin.blade.php ENDPATH**/ ?>