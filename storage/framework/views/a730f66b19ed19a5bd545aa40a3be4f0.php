...
<div class="btn-group" role="group">
    ...
    <div class="action-btn  ms-2">
        <a href="<?php echo e(route('quote.edit', $previous)); ?>" class="btn btn-sm btn-primary btn-icon m-1"
    ...
    <?php if(!empty($next)): ?>
    <div class="action-btn  ms-2">
        <a href="<?php echo e(route('quote.edit', $next)); ?>" class="btn btn-sm btn-primary btn-icon m-1"
        ...
        <div class="row">
            ...
            <div class="col-xl-9">
                <div id="useradd-1" class="card">
                    <?php echo e(Form::model($quote, ['route' => ['quote.update', $quote->id], 'method' => 'PUT'])); ?>
                    ...
                    <div class="card-header">
                        ...
                        <div class="float-end">
                            <a href="#" data-size="md" class="btn btn-sm btn-primary "
                               ...
                               data-url="<?php echo e(route('generate', ['quote'])); ?>" data-toggle="tooltip"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo Form::select('lead', $lead, $quote->lead_id, ['id' => 'lead', 'class' => 'form-control', 'required' => 'required']); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::text('quote_number', \Auth::user()->quoteNumberFormat($quote->quote_id), ['class' => 'form-control', 'placeholder' => __('Enter Quote Number'), 'required' => 'required','disabled'])); ?>

                                        <input type="hidden" name="quote_id" id="quote_id" value="<?php echo e($quote->quote_id); ?>">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo e(Form::date('date_quoted', date('Y-m-d'), ['class' => 'form-control datepicker', 'placeholder' => __('Enter Date Quoted'), 'required' => 'required'])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <?php echo e(Form::text('billing_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Postal Code')])); ?>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        <?php echo e(Form::text('shipping_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Shipping Postal Code')])); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <?php echo Form::select('user', $user, $quote->user_id, ['class' => 'form-control']); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" id="status" class="form-control" required>
                                ...
                                <option value="<?php echo e($k); ?>"
                                        <?php echo e($quote->status == $k ? 'selected' : ''); ?>><?php echo e(__($v)); ?>
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="text-end">
                            <a href="#" data-size="lg"
                               data-url="<?php echo e(route('salesorder.create', ['quote', $quote->id])); ?>"
                               data-bs-toggle="tooltip"data-ajax-popup="true"
                               title="<?php echo e(__('Create')); ?>"data-title="<?php echo e(__('Create New Sales Orders')); ?>"
                    ...
                    <table class="table datatable" id="datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span
                                        class="budget"><?php echo e(\Auth::user()->priceFormat($salesorder->amount)); ?></span>
                                </td>
                                <td class="text-right">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="text-end">
                            <a href="#" data-size="lg"
                               data-url="<?php echo e(route('invoice.create', ['quote', $quote->id])); ?>"
                               data-ajax-popup="true" data-bs-toggle="tooltip"
                               data-title="<?php echo e(__('Create New Invoice')); ?>" title="<?php echo e(__('Create')); ?>"
                               class="btn btn-sm btn-primary btn-icon-only ">
                                <i class="ti ti-plus"></i>
                            </a>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\CRM\resources\views/quote/edit.blade.php ENDPATH**/ ?>