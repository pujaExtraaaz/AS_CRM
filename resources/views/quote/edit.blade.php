                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('lead', $lead, $quote->lead_id, ['id' => 'lead', 'class' => 'form-control', 'required' => 'required']) !!}
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        {{ Form::label('quote_number', __('Quote Number'), ['class' => 'form-label']) }}
                                        {{ Form::text('quote_number', \Auth::user()->quoteNumberFormat($quote->quote_id), ['class' => 'form-control', 'placeholder' => __('Enter Quote Number'), 'required' => 'required','disabled']) }}
                                        <input type="hidden" name="quote_id" id="quote_id" value="{{$quote->quote_id}}">
                                        @error('quote_number')
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::text('billing_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Billing Postal Code')]) }}
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        {{ Form::text('shipping_postalcode', null, ['class' => 'form-control', 'placeholder' => __('Enter Shipping Postal Code')]) }}
