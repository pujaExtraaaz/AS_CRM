...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo e(Form::number('budget',null,array('class'=>'form-control','placeholder'=>__('Enter Price')))); ?>
...
<?php /**PATH D:\xampp\htdocs\CRM\resources\views/campaign/create.blade.php ENDPATH**/ ?>