...
@section('page-title')
{{ __('Users Setting Edit') }}
@endsection
@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{ route('dashboard') }}">{{ __('Home') }}</a></li>
<li class="breadcrumb-item"><a href="{{ route('user.index') }}">{{ __('Users Setting') }}</a></li>
...
<div class="d-inline-block">
    <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{ __('Edit Users Setting (') }} {{ $user->name }}
        {{ ')' }}</h5>
</div>
@endsection
@section('content')
