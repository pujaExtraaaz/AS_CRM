...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo Form::date('publish_date', date('Y-m-d'),array('class' => 'form-control')); ?>
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <?php echo Form::date('expiration_date', date('Y-m-d'),array('class' => 'form-control')); ?>
...
<?php /**PATH D:\xampp\htdocs\CRM\resources\views/document/create.blade.php ENDPATH**/ ?>